 ...
 * @author pshersby
 */
public class ValueForKeyTest {
    
    public ValueForKeyTest() {
    }
    ...
    /**
     * Test of evaluate method, of class ValueForKey.
     */
    @Test
    public void testEvaluate() {
        System.out.println("evaluate ValueForKey");
        EntityInstance ei = null;
        Object[] os = {"RC=1:COMPQ=1:BF=REALL AN :X3=17","BF",":"};
        ValueForKey instance = new ValueForKey();
        Object expResult = "REALL AN";

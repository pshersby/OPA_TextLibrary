...
public class CheckNameCompatibilityTest {
    ...
    public void testEvaluate3names() {
        ...
        Object[] os = {"John Andrew Smith","MR J SMITH", true};
        ...
        EntityInstance ei = null;
        Object[] os = {"John Andrew Smith","MR J SMITH BUSINESS ACCOUNT",  "PERSON", "GBP"};
        ...
        System.out.println("evaluate3b");
        EntityInstance ei = null;
        Object[] os = {"John Andrew Smith","Smith, John", "PERSON", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);
        ...
        System.out.println("evaluate3b");
        EntityInstance ei = null;
        Object[] os = {"Tim Andrew Smith","Smith, Timothy", "PERSON", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);
        ...
        System.out.println("evaluate3b");
        EntityInstance ei = null;
        Object[] os = {"Atom filters (UK) Ltd","Atom Filters LTD", "COMPANY", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);
        ...
        EntityInstance ei = null;
        Object[] os = {"JA Smith","John Smith", "PERSON", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);
        ...
        System.out.println("Initials1");
        EntityInstance ei = null;
        Object[] os = {"JA Smith","John Andrew Smith", "PERSON", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);
        ...
        System.out.println("Initials1");
        EntityInstance ei = null;
        Object[] os = {"JA Smith","John Bob Smith", "PERSON", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        ...
        assertEquals(expResult, result);
                               ...
                               @Test
        public void testWeird_ending() {
        System.out.println("LimitedStuckOnEnd");
        EntityInstance ei = null;
        Object[] os = {"SMITH DEVELOPERS LIMITED","SMITH DEVELOPMENT LIMITED", "COMPANY", "GBP"};
        CheckBankNameCompatibility instance = new CheckBankNameCompatibility();
        Object expResult = true;
        Object result = instance.evaluate(ei, os);
        assertEquals(expResult, result);

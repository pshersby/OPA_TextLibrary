...
/**
 * An OPA custom function Extension class that finds matching strings*/
public class ContainsAnyOf extends CustomFunction{
 ...
 * <p>Usage:  text_attribute = Trim(text_attribute/expression)
    ...
    public Object evaluate(EntityInstance ei, Object[] os) {
        ...
        String [] textToFind = searchStrings.split(delimiter);
        
        for (String e : textToFind){

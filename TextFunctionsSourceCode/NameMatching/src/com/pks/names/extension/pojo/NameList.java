...
public class NameList implements InameList 
{
    ...
    public NameList (String phrase, Dictionary dictionaryObject, String spaceList, boolean isPerson, boolean stripLastBracket){
        ...
        this.substitute(dictionaryObject,words);
        ...
        if (words.size()>1 && stripLastBracket && phrase.contains("(" + getLastWord() + ")")) {
     ...
     * use a tokeniser but this approach is fairly efficient and easy to configure
